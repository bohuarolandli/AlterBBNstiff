...
/* structure containing the cosmological model parameters */
{
    ...
    double dd0_rad;             // kappa_i of extra radiation which redshifts as a^{-4}
...
void Init_cosmomodel_param(double eta, double Nnu, double dNnu, double dd0_rad, double life_neutron, double life_neutron_error, double xinu1, double xinu2, double xinu3, struct relicparam* paramrelic);
