...
1. A dark radiation component parametrized by its energy density ratio to photons at the initial temperature of BBN calculations ($T_i=27\times10^9\\mathrm{K}$), **$\kappa_{\mathrm{rad},i}$**.
